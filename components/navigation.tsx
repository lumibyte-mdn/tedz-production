        ...
        <nav aria-label="Global" className="flex items-center justify-between py-6 max-w-7xl mx-auto">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <Image src={tedz} alt="icon" width={160} height={160} />
            </a>
          </div>
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-base hover:text-[#FFD300] font-semibold">
                {item.name}
              </a>
            ))}
          </div>
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#" className="text-base font-semibold bg-[#FFD300] px-8 py-3 text-black rounded-md">
              CHAT WHATSAPP
            </a>
          </div>
        </nav>
